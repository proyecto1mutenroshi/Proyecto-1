...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2018 a las 20:28:50
...
(4, 'Carlos', 'Dueñas Marín', '23125478M', 'cduenyas', '1234', '678996332');
...
(11, 'Sala de actos 1', 1, 0),
(12, 'Sala de actos 2', 1, 0),
(13, 'Proyector 1', 2, 0),
(14, 'Proyector 2', 2, 0),
(15, 'Portatil 1', 2, 0),
(16, 'Portatil 2', 2, 0),
...
CREATE TABLE `tbl_reserva` (
  ...
  `nombre_recurso` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre del recurso que se reserva',
...
--
ALTER TABLE `tbl_reserva`
  MODIFY `id_reserva` int(100) NOT NULL AUTO_INCREMENT COMMENT 'Clave primaria', AUTO_INCREMENT=5;
